  ...
  return (
    <div className="w-full h-screen bg-white dark:bg-[#010101]  mt-[50px] px-[30px] py-[40px] flex items-center justify-around flex-wrap">
      {panel.map((item, id) => (
        <div
          key={id}
          className="dark:bg-[#212121] mt-[40px] bt-[60px] cursor-pointer rounded-md shadow-lg flex flex-col items-center justify-center px-[20px] py-[30px] w-[350px] h-[250px] hover:scale-110 hover:dark:bg-[#333333] transition-all duration-200"
        >

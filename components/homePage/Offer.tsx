...
export default function Offer() {
  ...
  return (
    <div className="w-full bg-[#f4f6f3] dark:bg-[#356375] py-[30px]">
      <h2 className="text-center text-[34px] uppercase text-[#264653] dark:text-[white] my-[25px] mb-[20px] underline">
        What We Offer
      </h2>
      <div className=" w-full m-auto grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 gap-6 py-[30px]">
        {offers.map((item) => (
          <div
            key={item.id}

...
const EditProductButton = ({
  ...
  return (
    <>
      <button
        className="border border-[#5a5f5a] text-[20px] text-[#5a5f5a] tracking-widest uppercase rounded-md mt-[25px] py-[10px] px-[5px] w-[200px] cursor-pointer  dark:bg-[#264653] dark:text-[#ffffff] mb-[40px]"
        onClick={handleModal}
      >
        edit Product
      </button>
